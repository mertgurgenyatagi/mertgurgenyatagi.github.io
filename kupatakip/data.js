...
const BRACKET = {
  match_1:  { home: "South Africa",          away: "Canada",                   round: "RO32", date: "28 Haz", datetime: "2026-06-28T20:00:00Z" },
  match_2:  { home: "Germany",               away: "Paraguay",                 round: "RO32", date: "29 Haz", datetime: "2026-06-29T17:00:00Z" },
  match_3:  { home: "Netherlands",           away: "Morocco",                  round: "RO32", date: "29 Haz", datetime: "2026-06-29T20:00:00Z" },
  match_4:  { home: "Brazil",                away: "Japan",                    round: "RO32", date: "29 Haz", datetime: "2026-06-29T23:00:00Z" },
  match_5:  { home: "France",                away: "Sweden",                   round: "RO32", date: "30 Haz", datetime: "2026-06-30T17:00:00Z" },
  match_6:  { home: "Ivory Coast",           away: "Norway",                   round: "RO32", date: "30 Haz", datetime: "2026-06-30T20:00:00Z" },
  match_7:  { home: "Mexico",                away: "Ecuador",                  round: "RO32", date: "30 Haz", datetime: "2026-06-30T23:00:00Z" },
  match_8:  { home: "England",               away: "DR Congo",                 round: "RO32", date: "1 Tem",  datetime: "2026-07-01T17:00:00Z" },
  match_9:  { home: "United States",         away: "Bosnia and Herzegovina",   round: "RO32", date: "1 Tem",  datetime: "2026-07-01T20:00:00Z" },
  match_10: { home: "Belgium",               away: "Senegal",                  round: "RO32", date: "1 Tem",  datetime: "2026-07-01T23:00:00Z" },
  match_11: { home: "Portugal",              away: "Croatia",                  round: "RO32", date: "2 Tem",  datetime: "2026-07-02T17:00:00Z" },
  match_12: { home: "Spain",                 away: "Austria",                  round: "RO32", date: "2 Tem",  datetime: "2026-07-02T20:00:00Z" },
  match_13: { home: "Switzerland",           away: "Algeria",                  round: "RO32", date: "2 Tem",  datetime: "2026-07-02T23:00:00Z" },
  match_14: { home: "Argentina",             away: "Cape Verde",               round: "RO32", date: "3 Tem",  datetime: "2026-07-03T17:00:00Z" },
  match_15: { home: "Colombia",              away: "Ghana",                    round: "RO32", date: "3 Tem",  datetime: "2026-07-03T20:00:00Z" },
  match_16: { home: "Australia",             away: "Egypt",                    round: "RO32", date: "3 Tem",  datetime: "2026-07-03T23:00:00Z" },
  // Son 16 - kazananlar buluşuyor
  match_17: { home: null, away: null, round: "RO16", homeFrom: "match_2",  awayFrom: "match_5"  },
  match_18: { home: null, away: null, round: "RO16", homeFrom: "match_1",  awayFrom: "match_3"  },
  match_19: { home: null, away: null, round: "RO16", homeFrom: "match_4",  awayFrom: "match_6"  },
  match_20: { home: null, away: null, round: "RO16", homeFrom: "match_7",  awayFrom: "match_8"  },
  match_21: { home: null, away: null, round: "RO16", homeFrom: "match_11", awayFrom: "match_12" },
  match_22: { home: null, away: null, round: "RO16", homeFrom: "match_9",  awayFrom: "match_10" },
  match_23: { home: null, away: null, round: "RO16", homeFrom: "match_14", awayFrom: "match_16" },
  match_24: { home: null, away: null, round: "RO16", homeFrom: "match_13", awayFrom: "match_15" },
  // Çeyrek Final
  match_25: { home: null, away: null, round: "QF", homeFrom: "match_17", awayFrom: "match_18" },
  match_26: { home: null, away: null, round: "QF", homeFrom: "match_21", awayFrom: "match_22" },
  match_27: { home: null, away: null, round: "QF", homeFrom: "match_19", awayFrom: "match_20" },
  match_28: { home: null, away: null, round: "QF", homeFrom: "match_23", awayFrom: "match_24" },
  // Yarı Final
  match_29: { home: null, away: null, round: "SF", homeFrom: "match_25", awayFrom: "match_26" },
  match_30: { home: null, away: null, round: "SF", homeFrom: "match_27", awayFrom: "match_28" },
  // 3. lük maçı (puanlamada kullanılmaz)
  match_31: { home: null, away: null, round: "3RD", loserFrom: ["match_29","match_30"] },
  // Final
  match_32: { home: null, away: null, round: "Final", homeFrom: "match_29", awayFrom: "match_30" }
};

...
def main():
    ...
    ckpt_path = "checkpoints/free_pick_optimal.pt"
    ...
    torch.save(net.state_dict(), "checkpoints/free_pick_optimal.pt")
    print("Saved checkpoints/free_pick_optimal.pt")
